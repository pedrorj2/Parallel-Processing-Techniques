# File: code/6_state_formulation/version2/version2_1D.jl
...
function main()
    ...
    gif(anim, "code/6_state_formulation/version2/version2_animation.gif", fps=30)

    t_fin4 = time()

    # Timing info
    open("code/6_state_formulation/version2/version2_timings.txt", "w") do file
        write(file, "1‑D wave – version 2 (return-style helpers)\n")
